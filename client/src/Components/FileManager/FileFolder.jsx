      ...
      <div>
        {data.isFolder ? (
          <div>
            <div
              id={data.id}
              className="border flex flex-row justify-between cursor-pointer bg-slate-100 p-2"
            ...
            >
              ...
              <div className="flex flex-row gap-2 mx-2">
                <button
                  ...
                  onClick={(e) => handleNewFileFolder(e, true)}
                >
                  +📁
                </button>
                <button
                  className="border p-1 "
                  onClick={(e) => handleNewFileFolder(e, false)}
                >
                  +📄
                </button>
              </div>
          ...
          <div>
            <div id={data.id} className="border flex flex-row gap-2 p-1">
              <h1>📄</h1>
              <h1>{data.name}</h1>
            </div>
          </div>
